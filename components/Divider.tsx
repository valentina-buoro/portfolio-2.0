  ...
  return (
    <div className="w-screen md:w-full  ">
      <div className="h-14 bg-gradient-to-r from-purple-900 via-purple-300 to-purple-700">
        <div className="h-14 transform rotate-[-4.068deg] flex-1 bg-[#000;] border border-[#4D0071]  absolute -left-[19%] w-[120%]   flex items-center justify-center overflow-hidden">
          ...
          <div className="hidden text-white text-center text-xs md:text-xl font-normal w-full lg:flex  justify-around items-center scroll-containers secondary-text ">
          <span className="block mx-4">Coding</span>
            <span className="block mx-4">Debugging</span>
            <span className="block mx-4">Refactoring</span>
            <span className="block mx-4">Code Review</span>
