...
const Contact = () => {
  return (
    <div className='px-20 h-[90vh] flex flex-col justify-center mt-16'>
      <div className="flex">
        <div className="bg-[#231F29] p-8 flex flex-col justify-around w-[22.4rem]">
          <div>
            <p className="text-white text-3xl font-semibold">Have an Awesome Project Idea?<span className='text-[#9C00E5]'>Let’s Discuss</span> </p>
